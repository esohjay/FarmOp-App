...
const {isLoggedin, validateEgg} = require('../middleware')
...
router.post('/', isLoggedin, validateEgg, catchAsync( async (req, res) => {
   const {id} = req.params
...
router.delete('/:eId', isLoggedin, catchAsync( async(req, res) => {
